...
int CButton1View::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	m_radio1.Create(_T("라디오 버튼 1"), WS_CHILD | WS_VISIBLE | WS_GROUP | BS_AUTORADIOBUTTON,
		CRect(20, 170, 160, 200), this, 105);
	m_radio2.Create(_T("라디오 버튼 2"), WS_CHILD | WS_VISIBLE | BS_AUTORADIOBUTTON,
		CRect(20, 210, 160, 240), this, 106);
	m_groupbox.Create(_T("그룹 박스"), WS_CHILD | WS_VISIBLE | BS_GROUPBOX,
		CRect(10, 140, 360, 250), this, 104);
	m_radio3.Create(_T("라디오 버튼 A"), WS_CHILD | WS_VISIBLE | BS_AUTORADIOBUTTON,
		CRect(200, 170, 350, 200), this, 107);
	m_radio4.Create(_T("라디오    버튼    B"), WS_CHILD | WS_VISIBLE | BS_AUTORADIOBUTTON,
		CRect(200, 210, 350, 240), this, 108);
	// 버튼 컨트롤을 초기화한다.
